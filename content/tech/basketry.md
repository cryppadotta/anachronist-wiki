...
prerequisites:
  - slug: cordage-fiber
    ...
    role: Basketry needs flexible fibers, splints, stems, or roots.
unlocks:
  - slug: clay
    title: Clay
    kind: tooling
...
- [[cordage-fiber|Cordage fiber]] recognition.
- [[cutting-edge|Cutting edges]] for harvesting and trimming.
- [[tensile-test|Tensile testing]] for handles and load-bearing straps.
