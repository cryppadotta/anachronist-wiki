...
prerequisites:
  - slug: firekeeping
    title: Firekeeping
    kind: hard
    role: Maintaining and observing controlled fires is required.
  - slug: clay
    title: Clay
    kind: optional
...
- [[clay|Clay]] or earth for sealing.
- [[counting|Counting]] and [[writing|writing]] for batch records once production matters.
...
1. Dry and sort wood before the burn.
2. Build a small test pile or pit rather than starting at production scale.
3. Cover with earth or clay-rich material while preserving controlled draft.
4. Watch smoke, smell, collapse, and hot spots.
5. Seal leaks that turn the charge into open flame.
6. Let the batch cool fully before sorting.
...
Charcoal supports [[kiln|kiln]] work, metalworking prerequisites, black pigment for [[ink|ink]], and cleaner heat for workshops.
