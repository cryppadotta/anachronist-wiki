...
prerequisites:
  - slug: kiln
    title: Kiln
    kind: tooling
    role: A kiln or controlled firing structure is the test environment.
  - slug: clay
    title: Clay
...
- [[clay|Clay]] selection.
- [[kiln|Kiln]] or controlled firing structure.
- [[workshop-records|Workshop records]] for comparing results.

## Materials and sourcing

The materials are clay bodies, tempers, labels, fuel, and test locations. Source candidate clays from several layers and tempers from sand, [[grog|grog]], shell, fiber, or crushed rock.
