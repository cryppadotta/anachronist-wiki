...
prerequisites:
  - slug: writing
    title: Writing
    kind: optional
    role: Written rules and logs help norms persist across households.
  - slug: counting
    title: Counting
    kind: optional
    role: Counting illness events and inspections helps identify patterns.
unlocks:
  - slug: paper
    title: Paper
    kind: institutional
...
- [[counting|Counting]] for inspection and illness tallies.
- [[writing|Writing]] where rules and logs must outlive individual memory.
...
1. Map drinking water, waste, animals, food storage, and washing places.
2. Separate clean and dirty routes where possible.
3. Assign maintenance roles for water points and drains.
4. Teach rules through repeated work, not slogans.
5. Record failures and illness clusters when records are available.
