...
node_type: material
status: draft
summary: Bark Fiber is a practical supply chain for expanding the static
...
prerequisites:
  - slug: timber
    title: Timber
    kind: hard
    role: Timber provides a necessary starting point for first trials.
  - slug: cutting-edge
    title: Cutting edge
    kind: soft
...
material_dependencies:
  - slug: bark-fiber-supply
    title: Bark fiber supply
    importance: hard
...
Bark Fiber adds another practical node to the static technology tree. The page treats it as an early, inspectable capability that can be sourced, tested, taught, and improved without modern infrastructure.

## What you are trying to make

Create a small reliable version of bark fiber that proves the relevant material, tool, process, measurement, or social practice works in local conditions.

## Minimum viable version

The minimum version uses bark fiber supply, simple workshop habits, and a trial small enough to fail safely. It should produce a retained sample, a short record, and one visible quality check.
...
- [[timber|Timber]] supports the first dependable version.
- [[cutting-edge|Cutting edge]] supports the first dependable version.

## Materials and sourcing

Source bark fiber supply from local ecology, geology, salvage, household production, trade, or waste streams. Recognition begins with visible condition, texture, smell where relevant, contamination, seasonality, and whether a small sample survives first use.
...
A useful bark fiber result repeats from the same source and fails visibly before it endangers important work. Check fit, strength, wear, shrinkage, contamination, cracking, loosening, alignment, or record clarity as appropriate. Compare new batches against retained references.
